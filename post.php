            ...
            <div class="panel panel-default">
              ...
              ?>
                ...
                <div class="upload-drop-zone" id="drop-zone">
                  ...
                  <a href="" onclick="document.getElementById('upload').click(); return false">ที่อัพโหลด (Upload)</a>
                </div>
          ...
          <div class="container mt-3">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">ราคา (price)</span>
                  </div>
              ...
              <div class="col-md-2 d-none">
                <div class="form-check form-switch">
                  ...
                  <label class="form-check-label" for="flexSwitchCheckDefault">พรีเมี่ยม (Premium)</label>
              ...
              <div class="col-md-3 d-none">
                <div class="form-check form-switch">
                  ...
                  <label class="form-check-label" for="flexSwitchCheckDefault2">เริ่ม1บาท (Penny Start)</label>
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <select name="type" class="form-select" aria-label="Default select example">
                  <option value="15" <?php echo $type == '15' ? 'selected' : ''?>>ปลากัด (Plakat)</option>
                  <option value="49" <?php echo $type == '49' ? 'selected' : ''?>>ปลากัดหางพระจันทร์ครึ่งดวง (Half Moon)</option>
                  <option value="50" <?php echo $type == '50' ? 'selected' : ''?>>ปลากัดหางมงกุฎ (Crowntail)</option>
                  <option value="51" <?php echo $type == '51' ? 'selected' : ''?>>ปลากัดหูช้าง (Dumbo)</option>
                  <option value="78" <?php echo $type == '78' ? 'selected' : ''?>>ปลากัดเอเลี่ยน (Wild Alien)</option>
                  <option value="79" <?php echo $type == '79' ? 'selected' : ''?>>ปลากัดหูช้างหางพระจันทร์ครึ่งดวง (Dumbo Half Moon)</option>
                  <option value="80" <?php echo $type == '80' ? 'selected' : ''?>>ปลากัดหางคู่ (Double Tail)</option>
                  <option value="123" <?php echo $type == '123' ? 'selected' : ''?>>ปลากัดอีสาน (Isan)</option>
                </select>
              ...
              <div class="col-md-3">
                ...
                <select name="nickname" class="form-select" aria-label="Default select example">
                  ...
                  <option value="54" <?php echo $nickname == '54' ? 'selected' : ''?>>นีโม่ (Nemo)</option>
                  <option value="55" <?php echo $nickname == '55' ? 'selected' : ''?>>นีโม่กาแลคซี่ (Nemo Galaxy)</option>
                  <option value="73" <?php echo $nickname == '73' ? 'selected' : ''?>>มังกร (Dragon)</option>
                  <option value="57" <?php echo $nickname == '57' ? 'selected' : ''?>>อวตาร (Avatar)</option>
                </select>
              </div>
              <div class="col-md-3">
                <h2>เพศ (gender)</h2>
                ...
                <select id="gender" name="gender" class="form-select" aria-label="Default select example">
                  <option value="1" <?php echo $gender == '1' ? 'selected' : ''?>>เพศผู้ (Male)</option>
                  <option value="2" <?php echo $gender == '2' ? 'selected' : ''?>>เพศเมีย (Female)</option>
                  <option value="3" <?php echo $gender == '3' ? 'selected' : ''?>>คู่ (Pair)</option>
                </select>
              </div>
              <div class="col-md-3">
                <h2>อายุ (age)</h2>
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append">
                    <span class="input-group-text" id="basic-addon2">เดือน (month)</span>
                    <!-- Note:
...
// 		JP: 【現地直送でも安心】 100%死着保証! 送料には国際発送 + 税関処理 + 国内発送全ての料金が含まれています。  
	
// 	- Generate title:
// 		EN: Betta + $type + $nickname (if any) + $gender + $color + Aquarium Live Fish
// 		JP: 【現地直送】 ベタ + $type + $nickname (if any) + $gender + $color

// 	- youtube title:
// 		#shorts Betta Aquarium ベタ 熱帯魚 + $sku
